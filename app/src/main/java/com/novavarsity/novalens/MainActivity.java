package com.novavarsity.novalens;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getSearchResults(String searchQuery){
        String url = "https://serpapi.com/search.json?q="+searchQuery+"&api_key=f3ea3db487b04f09876a6c6a77cce344af72b7dcb3a110aa4dfba03897dc6804&location=Delhi,India&hl=en&gl=us&google_domain=google.com";
                ...
                try {
                    ...
                    for(int i=0;i<organicArray.length(); i++){
                        ...
                        if(organicObj.has("snippet")){
                            displayedLink = organicObj.getString("snippet");
                        }
